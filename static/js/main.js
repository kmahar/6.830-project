...
d3.json("static/json/states.json", function(error, us) {
  map.selectAll("path")
  ...
  //d3.csv("static/csv/join.csv",function(data){
  d3.csv("static/csv/jobs.csv",function(data){
    var first = data[0];
    console.log(first); 
    // get columns
    for ( var mug in first ){
      ...
      // if ( mug != "meetup_venue_lat" && mug != "meetup_venue_lon" ){
